    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "creator",
                    models.ForeignKey(to=settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.SET_NULL),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                related_name="vouchers", to="voucher.VoucherGroup", null=True, blank=True, on_delete=models.SET_NULL
            ),
        ),
        migrations.AddField(
            model_name="voucher",
