...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CartItemPropertyValue.property_group'
        db.add_column(u'cart_cartitempropertyvalue', 'property_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.PropertyGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CartItemPropertyValue.property_group'
        db.delete_column(u'cart_cartitempropertyvalue', 'property_group_id')
    ...
    models = {
        ...
        u'cart.cartitempropertyvalue': {
            'Meta': {'object_name': 'CartItemPropertyValue'},
            'cart_item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'properties'", 'to': u"orm['cart.CartItem']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'property': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalog.Property']"}),
            'property_group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalog.PropertyGroup']", 'null': 'True', 'blank': 'True'}),
        ...
        u'catalog.product': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'b7119f18-4233-46cb-9f80-4b0d8ec8919b'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'catalog.property': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'ea8161db-e747-4713-aad9-62d74df10118'", 'unique': 'True', 'max_length': '50'}),
