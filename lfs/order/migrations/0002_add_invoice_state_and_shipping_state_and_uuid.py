...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.invoice_state'
        db.add_column('order_order', 'invoice_state', models.CharField(_(u"Invoice state"), max_length=50))
        
        # Adding field 'Order.shipping_state'
        db.add_column('order_order', 'shipping_state', models.CharField(_(u"Shipping state"), max_length=50))
        
        # Adding field 'Order.uuid'
        db.add_column('order_order', 'uuid', models.CharField(default=get_unique_id_str, unique=True, max_length=50, editable=False))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Order.invoice_state'
        db.delete_column('order_order', 'invoice_state')
        
        # Deleting field 'Order.shipping_state'
        db.delete_column('order_order', 'shipping_state')
        
        # Deleting field 'Order.uuid'
        db.delete_column('order_order', 'uuid')
