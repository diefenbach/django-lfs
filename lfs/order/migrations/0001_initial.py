    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(max_length=30, verbose_name="Bank identication code", blank=True),
                ),
                ...
                (
                    "uuid",
                    models.CharField(
                        default=lfs.order.models.get_unique_id_str, unique=True, max_length=50, editable=False
                    ),
                ),
                ...
                (
                    "ia_content_type",
                    models.ForeignKey(
                        related_name="order_invoice_address", to="contenttypes.ContentType", on_delete=models.CASCADE
                    ),
                ),
                (
                    "payment_method",
                ...
                (
                    "sa_content_type",
                    models.ForeignKey(
                        related_name="order_shipping_address", to="contenttypes.ContentType", on_delete=models.CASCADE
                    ),
                ),
                (
                    "shipping_method",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "product",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.SET_NULL, blank=True, to="catalog.Product", null=True
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "property",
                    models.ForeignKey(verbose_name="Property", to="catalog.Property", on_delete=models.CASCADE),
                ),
            ],
        ),
    ]
