        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(max_length=30, verbose_name="Bank identification code", blank=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(null=True, verbose_name="Expiration date month", blank=True),
                ),
                (
                    "expiration_date_year",
                    models.IntegerField(null=True, verbose_name="Expiration date year", blank=True),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ia_content_type",
                    models.ForeignKey(
                        related_name="ia_content_type", to="contenttypes.ContentType", on_delete=models.CASCADE
                    ),
                ),
                (
                    "sa_content_type",
                    models.ForeignKey(
                        related_name="sa_content_type", to="contenttypes.ContentType", on_delete=models.CASCADE
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        verbose_name="Selected payment method",
                        blank=True,
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        verbose_name="Selected shipping method",
                        blank=True,
                ...
                (
                    "user",
                    models.ForeignKey(blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.SET_NULL),
                ),
            ],
        ),
        migrations.AddField(
