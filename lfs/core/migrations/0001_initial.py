    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "google_analytics_id",
                    models.CharField(max_length=20, verbose_name="Google Analytics ID", blank=True),
                ),
                ("ga_site_tracking", models.BooleanField(default=False, verbose_name="Google Analytics Site Tracking")),
                (
                    "ga_ecommerce_tracking",
                    models.BooleanField(default=False, verbose_name="Google Analytics E-Commerce Tracking"),
                ),
                (
                    "use_international_currency_code",
                    models.BooleanField(default=False, verbose_name="Use international currency codes"),
                ),
                (
                    "price_calculator",
                    models.CharField(
                        default=b"lfs.gross_price.GrossPriceCalculator",
                        max_length=255,
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=0,
                        verbose_name="Checkout type",
                        choices=[(0, "Anonymous and Authenticated"), (1, "Anonymous only"), (2, "Authenticated only")],
                    ),
                ),
                ...
                (
                    "default_country",
                    models.ForeignKey(
                        verbose_name="Default shipping country",
                        to="core.Country",
                        blank=True,
                        null=True,
                ...
                (
                    "invoice_countries",
                    models.ManyToManyField(related_name="invoice", verbose_name="Invoice countries", to="core.Country"),
                ),
                (
                    "shipping_countries",
                    models.ManyToManyField(
                        related_name="shipping", verbose_name="Shipping countries", to="core.Country"
                    ),
                ),
                (
                    "static_block",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                related_name="actions", verbose_name="Group", to="core.ActionGroup", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="action",
            name="parent",
            field=models.ForeignKey(
                verbose_name="Parent", blank=True, to="core.Action", null=True, on_delete=models.SET_NULL
            ),
        ),
    ]
