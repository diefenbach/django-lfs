...
urlpatterns += patterns('lfs.customer.views',
    ...
    url(r'^changed-invoice-address', "changed_invoice_country", name="lfs_changed_my_invoice_country"),
    url(r'^changed-shipping-address', "changed_shipping_country", name="lfs_changed_my_shipping_country"),
