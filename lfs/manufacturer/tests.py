...
class ManufacturersTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.m1 = Manufacturer.objects.create(
            name="LFS C.O.", slug="lfs-co", short_description="sd", description="desc", position=1
        )
...
class ManufacturersManageTestCase(TestCase):
    ...
    def test_update_manufacturer(self):
        ...
        response = self.client.post(
            url,
            {"name": "Django C.O.", "slug": "django-co", "short_description": "short", "description": "description"},
        )
        self.assertEqual(response.status_code, 200)
        updated_man = Manufacturer.objects.get(pk=self.m1.pk)
        self.assertEqual(updated_man.short_description, "short")
        self.assertEqual(updated_man.description, "description")
