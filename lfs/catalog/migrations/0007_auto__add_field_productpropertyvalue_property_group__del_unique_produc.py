...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'catalog_productpropertyvalue', ['product_id', 'property_id', 'value', 'type'])

        # Adding field 'ProductPropertyValue.property_group'
        db.add_column(u'catalog_productpropertyvalue', 'property_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='property_values', null=True, to=orm['catalog.PropertyGroup']),
                      keep_default=False)

        # Adding unique constraint on 'ProductPropertyValue', fields ['product', 'property', 'property_group', 'value', 'type']
        db.create_unique(u'catalog_productpropertyvalue', ['product_id', 'property_id', 'property_group_id', 'value', 'type'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProductPropertyValue', fields ['product', 'property', 'property_group', 'value', 'type']
        db.delete_unique(u'catalog_productpropertyvalue', ['product_id', 'property_id', 'property_group_id', 'value', 'type'])

        # Deleting field 'ProductPropertyValue.property_group'
        db.delete_column(u'catalog_productpropertyvalue', 'property_group_id')

        # Adding unique constraint on 'ProductPropertyValue', fields ['product', 'property', 'value', 'type']
        db.create_unique(u'catalog_productpropertyvalue', ['product_id', 'property_id', 'value', 'type'])
    ...
    models = {
        ...
        u'catalog.category': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'25e54fef-1940-4e05-9b97-ed32d0301519'", 'unique': 'True', 'max_length': '50'})
        },
        ...
        u'catalog.product': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'071ef57a-d8b1-4859-9946-c84f1d730507'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'catalog.productpropertyvalue': {
            'Meta': {'unique_together': "(('product', 'property', 'property_group', 'value', 'type'),)", 'object_name': 'ProductPropertyValue'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'property_group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'property_values'", 'null': 'True', 'to': u"orm['catalog.PropertyGroup']"}),
        ...
        u'catalog.property': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'ee03439d-ccbd-4e35-8298-fb4faf8b334e'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'catalog.propertyoption': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'a39446d9-94b6-49c4-b6a5-5b319d29cbe8'", 'unique': 'True', 'max_length': '50'})
        },
