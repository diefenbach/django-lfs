    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    lfs.core.fields.thumbs.ImageWithThumbsField(
                        upload_to=b"images", null=True, verbose_name="Image", blank=True
                    ),
                ),
                    ...
                    models.PositiveSmallIntegerField(
                        ...
                        choices=[
                            (
                                0,
                                {
                                    b"image": b"/media/lfs/icons/product_default.png",
                                    b"name": "Category with products",
                                    b"file": b"lfs/catalog/categories/product/default.html",
                                },
                            ),
                            (
                                1,
                                {
                                    b"image": b"/media/lfs/icons/category_square.png",
                                    b"name": "Category with subcategories",
                                    b"file": b"lfs/catalog/categories/category/default.html",
                                },
                            ),
                        ],
                    ),
                ...
                (
                    "uid",
                    models.CharField(
                        default=lfs.catalog.models.get_unique_id_str, unique=True, max_length=50, editable=False
                    ),
                ),
                (
                    "parent",
                    models.ForeignKey(
                        verbose_name="Parent", blank=True, to="catalog.Category", null=True, on_delete=models.SET_NULL
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "unit",
                    models.PositiveSmallIntegerField(
                        default=2, verbose_name="Unit", choices=[(1, "hours"), (2, "days"), (3, "weeks"), (4, "months")]
                    ),
                ),
                ("description", models.TextField(verbose_name="Description", blank=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The name of the product.", max_length=80, verbose_name="Name", blank=True
                    ),
                ),
                (
                    "slug",
                    models.SlugField(
                        help_text="The unique last part of the Product's URL.",
                        unique=True,
                        max_length=120,
                        verbose_name="Slug",
                    ),
                ...
                (
                    "sku",
                    models.CharField(
                        help_text="Your unique article number of the product.",
                        max_length=30,
                        verbose_name="SKU",
                        blank=True,
                    ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            [b"lfs.gross_price.GrossPriceCalculator", "Price includes tax"],
                            [b"lfs.net_price.NetPriceCalculator", "Price excludes tax"],
                        ],
                    ),
                ),
                ...
                (
                    "meta_title",
                    models.CharField(default=b"<name>", max_length=80, verbose_name="Meta title", blank=True),
                ),
                ("meta_keywords", models.TextField(verbose_name="Meta keywords", blank=True)),
                ("meta_description", models.TextField(verbose_name="Meta description", blank=True)),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            (b"0", "Standard"),
                            (b"1", "Product with variants"),
                            (b"2", "Variant"),
                            (b"3", "Configurable product"),
                        ],
                    ),
                ),
                ...
                (
                    ...
                    models.IntegerField(
                        default=0, verbose_name="Variants display type", choices=[(0, "List"), (1, "Select")]
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name="Active short description"),
                ),
                ...
                (
                    "active_for_sale",
                    models.PositiveSmallIntegerField(
                        default=0, verbose_name="Active for sale", choices=[(0, "Standard"), (2, "Yes"), (3, "No")]
                    ),
                ),
                        ...
                        choices=[
                            (
                                0,
                                {
                                    b"image": b"/media/lfs/icons/product_default.png",
                                    b"name": "Default",
                                    b"file": b"lfs/catalog/products/product_inline.html",
                                },
                            )
                        ],
                    ),
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name="Active price calculation"),
                ),
                ...
                (
                    "base_price_amount",
                    models.FloatField(default=0.0, null=True, verbose_name="Base price amount", blank=True),
                ),
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        blank=True,
                        null=True,
                        verbose_name="Type of quantity field",
                        choices=[(0, "Integer"), (1, "Decimal 0.1"), (2, "Decimal 0.01")],
                    ),
                ),
                (
                    "uid",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "product",
                    models.ForeignKey(
                        related_name="productsproperties",
                        verbose_name="Product",
                        to="catalog.Product",
                        on_delete=models.CASCADE,
                    ),
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=2,
                        verbose_name="Type",
                        choices=[(1, "Float field"), (2, "Text field"), (3, "Select field")],
                    ),
                ),
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        ...
                        choices=[(1, "Automatic"), (2, "Fixed step"), (3, "Manual steps")],
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="property_groups", verbose_name="Products", to="catalog.Product"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "property",
                    models.ForeignKey(
                        related_name="options", verbose_name="Property", to="catalog.Property", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="catalog.GroupsPropertiesRelation",
                blank=True,
            ),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                to="catalog.Product",
                through="catalog.ProductsPropertiesRelation",
                blank=True,
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                related_name="property_values", verbose_name="Property", to="catalog.Property", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="productpropertyvalue",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                verbose_name="Acessories",
                to="catalog.Product",
                through="catalog.ProductAccessories",
                blank=True,
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                verbose_name="Default variant", blank=True, to="catalog.Product", null=True, on_delete=models.SET_NULL
            ),
        ),
        migrations.AddField(
            model_name="product",
        ...
        migrations.AddField(
            ...
            name="supplier",
            field=models.ForeignKey(
                related_name="product_set", blank=True, to="supplier.Supplier", null=True, on_delete=models.SET_NULL
            ),
        ),
        migrations.AddField(
            model_name="product",
        ...
        migrations.AddField(
            ...
            name="property",
            field=models.ForeignKey(
                related_name="steps", verbose_name="Property", to="catalog.Property", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="category",
            name="products",
            field=models.ManyToManyField(
                related_name="categories", verbose_name="Products", to="catalog.Product", blank=True
            ),
        ),
        migrations.AddField(
            model_name="category",
