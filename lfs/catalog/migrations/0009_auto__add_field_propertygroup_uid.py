...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropertyGroup.uid'
        db.add_column(u'catalog_propertygroup', 'uid',
                      self.gf('django.db.models.fields.CharField')(max_length=50, unique=True, null=True),
                      keep_default=False)

        for prop in orm.PropertyGroup.objects.all():
            prop.uid = str(uuid.uuid4())
            prop.save()

        db.alter_column(u'catalog_propertygroup', 'uid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))

    def backwards(self, orm):
        # Deleting field 'PropertyGroup.uid'
        db.delete_column(u'catalog_propertygroup', 'uid')
    ...
    models = {
        ...
        u'catalog.category': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'3e3e6170-a0d7-416d-b73f-8172cf231e36'", 'unique': 'True', 'max_length': '50'})
        },
        ...
        u'catalog.product': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'de512049-ce00-4484-95a3-ebca1e4df485'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'catalog.property': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'b2931da5-4fa3-4009-af01-5b9f54a4f95b'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'catalog.propertygroup': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'53fcdb9d-2631-4062-a389-9dcd675b380d'", 'max_length': '50', 'unique': 'True', 'null': 'True'})
        },
        u'catalog.propertyoption': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'a21862e7-3d90-4325-97cb-0b0811747c1a'", 'unique': 'True', 'max_length': '50'})
        },
