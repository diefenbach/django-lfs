...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'catalog_product', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=120))

    def backwards(self, orm):
        # Changing field 'Product.slug'
        db.alter_column(u'catalog_product', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=80, unique=True))
    ...
    models = {
        ...
        u'catalog.category': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'18538acb-aeba-4c22-a9ed-96396579deae'", 'unique': 'True', 'max_length': '50'})
        },
        ...
        u'catalog.product': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'ad0bc724-6880-4798-b4c4-d9d262bce57e'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'catalog.property': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'65fa4e5d-6f9e-4ae8-a64e-154e91884cda'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'catalog.propertygroup': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'3fe45b16-585a-4d8d-9580-fe39e84fd83e'", 'unique': 'True', 'max_length': '50'})
        },
        u'catalog.propertyoption': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'57cc063a-f369-4354-92ff-96a3e04ecd08'", 'unique': 'True', 'max_length': '50'})
        },
