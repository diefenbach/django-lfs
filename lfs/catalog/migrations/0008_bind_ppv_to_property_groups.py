...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for ppv in orm.ProductPropertyValue.objects.all():
            for idx, pgroup in enumerate(ppv.property.groups.all()):
                if idx == 0:
                    ppv.property_group = pgroup
                    ppv.save()
                else:
                    if not orm.ProductPropertyValue.objects.filter(product=ppv.product,
                                                                   parent_id=ppv.parent_id,
                                                                   property=ppv.property,
                                                                   property_group=pgroup,
                                                                   value=ppv.value,
                                                                   value_as_float=ppv.value_as_float,
                                                                   type=ppv.type).exists():
                        orm.ProductPropertyValue.objects.create(product=ppv.product,
                                                                parent_id=ppv.parent_id,
                                                                property=ppv.property,
                                                                property_group=pgroup,
                                                                value=ppv.value,
    ...
    models = {
        ...
        u'catalog.category': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'3c909391-2029-4236-91d7-309d1d95598b'", 'unique': 'True', 'max_length': '50'})
        },
        ...
        u'catalog.product': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'e37e67f5-388c-414c-a063-b33475504185'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'catalog.property': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'b0cd5687-06af-4ab7-be91-adf9923f88d4'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'catalog.propertyoption': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'0420a843-f1a7-4df1-b06a-e92abcb4ab81'", 'unique': 'True', 'max_length': '50'})
        },
