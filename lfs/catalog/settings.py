...
CATEGORY_TEMPLATES = (
    ...
    (1,{"file":"%s/%s" % (CAT_PRODUCT_PATH ,"variant_1.html"),
        "image":IMAGES_PATH+"/category_horizontal.png",
        "name":_(u"Category with products horizontal"),        
        }),
    (2,{"file":"%s/%s" % (CAT_CATEGORY_PATH ,"default.html"),
        "image":IMAGES_PATH+"/category_square.png",
        "name":_(u"Category with subcategories"),		        
        }),
    (3,{"file":"%s/%s" % (CAT_CATEGORY_PATH ,"variant_1.html"),
        "image":IMAGES_PATH+"/category_horizontal.png",
        "name":_(u"Category with subcategories horizontal"),		
        }),
)
...
PRODUCT_TEMPLATES = (
    ...
    (1,{"file":"%s/%s" % (PRODUCT_PATH ,"product_inline_topprice.html"),
        "image":IMAGES_PATH+"/product_priceup.png",
        "name":_(u"Price on top"),		
        }),
    (2,{"file":"%s/%s" % (PRODUCT_PATH ,"product_inline_topdescription.html"),
        "image":IMAGES_PATH+"/product_textup.png",
        "name":_(u"Description on top"),		
        }),
) 