        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "price_calculator",
                    models.CharField(
                        default=b"lfs.shipping.GrossShippingMethodPriceCalculator",
                        max_length=200,
                        verbose_name="Price Calculator",
                        choices=[
                            [b"lfs.shipping.GrossShippingMethodPriceCalculator", "Price includes tax"],
                            [b"lfs.shipping.NetShippingMethodPriceCalculator", "Price excludes tax"],
                        ],
                    ),
                ),
                (
                ...
                (
                    "tax",
                    models.ForeignKey(
                        verbose_name="Tax", blank=True, to="tax.Tax", null=True, on_delete=models.SET_NULL
                    ),
                ),
            ],
            options={
