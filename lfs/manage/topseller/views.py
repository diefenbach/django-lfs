...
@permission_required("core.manage_shop")
def manage_topseller(request, template_name="manage/topseller/topseller.html"):
    """ """
...
@permission_required("core.manage_shop")
def manage_topseller_inline(request, as_string=False, template_name="manage/topseller/topseller_inline.html"):
    """ """
...
def add_topseller(request):
    ...
    return render(
        request,
        "manage/topseller/topseller.html",
        context=context,
    )
