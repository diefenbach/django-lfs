...
def add_property(request, product_id):
    ...
    result = json.dumps(
        {
            "html": html,
            "message": _("Property has been added."),
        },
        cls=LazyEncoder,
    )
...
def delete_property(request, product_id, property_id):
    ...
    result = json.dumps(
        {
            "html": html,
            "message": _("Property has been deleted."),
            "close-dialog": True,
        },
        cls=LazyEncoder,
    )
...
def add_property_option(request, product_id):
    ...
    if property_option_form.is_valid():
        ...
        message = _("Invalid data. Correct it and try again.")
...
def add_variants(request, product_id):
    ...
    if variant_simple_form.is_valid():
        ...
        for i, options in enumerate(manage_utils.cartesian_product(*properties)):
            ...
            if added_count > 0:
                message = _("Variants have been added.")
        variant_simple_form = ProductVariantSimpleForm(all_properties=all_properties)
...
def update_variants(request, product_id):
    ...
    if action == "delete":
        message = _("Variants have been deleted.")
        ...
        message = _("Variants have been saved.")
...
def edit_sub_type(request, product_id):
    ...
    result = json.dumps(
        {
            "html": html,
            "message": _("Sub type has been saved."),
        },
        cls=LazyEncoder,
    )
...
def update_category_variant(request, product_id):
    ...
    result = json.dumps(
        {
            "html": html,
            "message": _("Category variant has been saved."),
        },
        cls=LazyEncoder,
    )
