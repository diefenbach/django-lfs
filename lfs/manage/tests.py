...
class ManageTestCase(TestCase):
    ...
    def test_manage_add_shop_property_option_with_locale(self):
        ...
        response = self.client.post(url, {"name": "testpropertyoption", "action": "add", "price": "0.5"}, follow=True)
        self.assertEqual(response.status_code, 200)
        new_property_option = PropertyOption.objects.latest("id")
        self.assertEqual(new_property_option.name, "testpropertyoption")
        ...
        response = self.client.post(url, {"name": "testpropertyoption2", "action": "add", "price": "0,7"}, follow=True)
    ...
    def test_manage_variants(self):
        ...
        variant = Product.objects.create(
            name="variant", slug="vslug", parent=product, variant_position=10, sub_type=VARIANT
        )
        ProductPropertyValue.objects.create(
            product=variant, property_id=pproperty.pk, value=property_option.pk, type=PROPERTY_VALUE_TYPE_VARIANT
        )
    ...
    def test_manage_add_price_criteria(self):
        ...
        data = {
            "type-123": "lfs.criteria.models.CountryCriterion",
