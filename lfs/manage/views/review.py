...
def set_review_filters(request):
    ...
    msg = _("Review filters have been set")
...
def reset_review_filters(request):
    ...
    msg = _("Review filters have been reset")
...
def delete_review(request, review_id):
    ...
    try:
        ordering = "%s%s" % (
            request.session.get("review-ordering-order", ""),
            request.session.get("review-ordering", "id"),
        )
    ...
    return lfs.core.utils.set_message_cookie(url, _("Review has been deleted."))
...
def set_review_state(request, review_id):
    ...
    msg = _("Review state has been set")
