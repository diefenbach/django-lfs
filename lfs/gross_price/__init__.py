...
class GrossPriceCalculator(PriceCalculator):
    ...
    def get_price_net(self, with_properties=True, amount=1):
        return self.get_price(with_properties, amount) / self._calc_product_tax_rate()
    ...
    def get_standard_price_net(self, with_properties=True, amount=1):
        return self.get_standard_price(with_properties, amount) / self._calc_product_tax_rate()
    ...
    def get_for_sale_price_net(self, with_properties=True, amount=1):
        return self.get_for_sale_price(with_properties, amount) / self._calc_product_tax_rate()
