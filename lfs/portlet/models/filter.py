...
class FilterPortlet(Portlet):
    ...
    show_product_filters = models.BooleanField(_("Show product filters"), default=True)
    show_price_filters = models.BooleanField(_("Show price filters"), default=True)
    show_manufacturer_filters = models.BooleanField(_("Show manufacturer filters"), default=False)
