            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        verbose_name="Variant", choices=[(0, "---"), (1, "Default"), (2, "Cheapest"), (3, "All")]
                    ),
                ),
                (
                    "category",
                    models.ForeignKey(verbose_name="Category", to="catalog.Category", on_delete=models.CASCADE),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "variants_option",
                    models.PositiveSmallIntegerField(
                        default=1, verbose_name="Variants", choices=[(1, "Default"), (2, "Cheapest"), (3, "All")]
                    ),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="exports", verbose_name="Products", to="catalog.Product", blank=True
                    ),
                ),
            ],
            options={
