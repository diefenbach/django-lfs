...
def create_paypal_link_for_order(order):
    ...
    info = {
        ...
        "city" : order.invoice_line3,
        "state" : order.invoice_line4,
        "zip" : order.invoice_line5,
        "no_shipping" : "1",
        "custom": order.uuid,
        "invoice": order.uuid,
...
def create_paypal_link_for_request(request):
    ...
    info = {
        ...
        "city" : invoice_address.line3,
        "state" : invoice_address.line4,
        "zip" : invoice_address.line5,
        "no_shipping" : "1",
        "custom": cart.id,
        "invoice": cart.id,
        "item_name" : shop.shop_owner,
